...
def display_score():
	score_text_surface = text.render("Score: " + str(score), True, (255,255,255))
...
def display_max_score():
	score_text_surface = text.render("Max Score: " + str(max_score), True, (255,255,255))
	score_text_rect    = score_text_surface.get_rect()
	score_text_rect.right = window_width - 10
...
restart_text = c.create_text(WIDTH/2, HEIGHT-HEIGHT/3,
                             font='Arial 30',
                             fill='white',
                             text="Нажмите ЛКМ, чтобы продолжить ",
                             state='hidden')
